...
var myCalendar = createCalendar({
    ...
    data: {
        ...
        // Sept 5, 2026 at 3:30 PM (LOCAL TIME)
        start: new Date(2026, 8, 5, 15, 30),

        // Same day, end of evening
...
$('#add-to-cal').html(myCalendar);
    ...
    $('#rsvp-form').on('submit', function (e) {
        ...
        $('#alert-wrapper').html(alert_markup('info', '<strong>One moment please!</strong> We are saving your details.'));

        if (MD5($('#invite_code').val()) !== '73deed4df97110d76cb8d699619e63b1') { 
            $('#alert-wrapper').html(alert_markup('danger', '<strong>Sorry!</strong> Your invite code is incorrect.')); 
        } else {

            $.post('https://script.google.com/macros/s/AKfycbxMtJmI63Cj_MAPAyohFqo1OTK-q6Mf4f6TpNW4x38bDRxgZ_E_5h-tbyxHz5QxggOIMA/exec', data)
                .done(function (data) {
                    console.log(data);
